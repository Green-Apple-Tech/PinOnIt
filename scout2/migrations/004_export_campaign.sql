-- Campaign tracking for GMass exports. Pipeline statuses (discovered … ready)
-- stay as they are. After a lead is exportable, status moves to
-- exported | sent | replied | bounced | unsubscribed | excluded.
