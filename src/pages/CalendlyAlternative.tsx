...
const CALENDLY_ALT_META = {
  ...
  url: 'https://pinonit.com/calendly-alternative',
  image: 'https://pinonit.com/pinonit_logo.png',
};

export function CalendlyAlternative() {
  const { user, loading } = useAuth();
  const { theme, toggleTheme } = useTheme();
  const navigate = useNavigate();
  usePageMeta(CALENDLY_ALT_META);
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white">
      ...
      <section className="relative overflow-hidden pt-20 pb-24 px-6 text-center">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <h1 className="text-xl md:text-2xl font-medium leading-snug text-slate-900 dark:text-white mb-8 max-w-3xl mx-auto">
            Clients book your calendar in seconds—with SMS reminders.
            <br />
            Send quotes, NDAs &amp; waivers by text, too. All for less.
          </h1>
