      ...
      <section className="relative overflow-hidden pt-10 pb-14 md:pt-16 md:pb-24 px-4 sm:px-6">
        ...
        <div className="relative max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl font-medium text-slate-600 dark:text-slate-300 leading-snug mb-2 max-w-xl mx-auto lg:mx-0">
              Built to help you handle your meetings, approvals, and customers by text.
            </p>
            <p className="text-base md:text-lg text-slate-500 dark:text-slate-400 leading-snug mb-8 max-w-xl mx-auto lg:mx-0">
              Easy Sign-by-Text — they sign from their phone.
            </p>
            <LandingHeroCtas />
          </div>
          <div>
