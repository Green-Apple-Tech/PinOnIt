...
import {
  ...
  Receipt, MessageSquare, MessageCircle, Phone,
} from 'lucide-react';
                ...
                {channels && (
                  <div className="flex items-center gap-2 mb-3">
                    {channels.includes('sms') && (
                      <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 text-xs font-semibold text-slate-600 dark:text-slate-300">
                        <span className="h-4 w-4 inline-flex items-center justify-center rounded bg-amber-100 dark:bg-amber-500/10 text-amber-700 dark:text-amber-300 text-[10px] font-black">
                          S
                        </span>
                        SMS
                      </span>
                    ...
                    {channels.includes('whatsapp') && (
                      <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-green-50 dark:bg-green-500/10 text-xs font-semibold text-green-700 dark:text-green-400">
                        <span className="h-4 w-4 inline-flex items-center justify-center rounded bg-green-500/15 dark:bg-green-500/10 text-green-700 dark:text-green-400 text-[10px] font-black">
                          WA
                        </span>
                        WhatsApp
                      </span>
