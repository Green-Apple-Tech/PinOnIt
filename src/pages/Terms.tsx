...
const sections: Section[] = [
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <p>
          PinOnIt Doc Center helps you send waivers, NDAs, contracts, quotes, invoices, and receipts for review or signature by text or link. Sign-by-Text <strong>meets federal ESIGN Act requirements for electronic signatures</strong>. <strong>Every signature includes a complete audit record</strong> (signer mobile number verified by one-time SMS code, signer name, event timestamps with timezone, IP address and user agent, SHA-256 hash, document text snapshot, signature image, consent statement captured verbatim, and unique document ID). A certificate of completion with that audit record is generated for the sender and retained for later retrieval, including after account cancellation. <strong>PinOnIt does not provide legal advice</strong> and does not predict legal outcomes for any particular document or dispute.
        </p>
        <ul className="space-y-2 pl-4">
          ...
          <li className="flex gap-2"><span className="text-brand-500 font-bold shrink-0">·</span><span><strong>ESIGN exclusions:</strong> PinOnIt is <strong>not intended</strong> for document types excluded from the federal ESIGN Act — including wills, codicils, testamentary trusts, and certain family-law and court documents — nor for powers of attorney, deeds, notarized instruments, multi-signer closings, or other formal instruments that typically require witnesses, notarization, or specialized formalities. You must not use the Service for illegal content or fraud.</span></li>
          <li className="flex gap-2"><span className="text-brand-500 font-bold shrink-0">·</span><span><strong>Single-signature business use:</strong> Sign-by-Text and PDF upload flows are designed for <strong>single-signature business documents</strong> (for example, waivers, NDAs, addendums, estimates, and job sign-offs).</span></li>
          <li className="flex gap-2"><span className="text-brand-500 font-bold shrink-0">·</span><span><strong>Uploaded PDFs:</strong> Uploaded files must be PDF only, within the stated size limit, and clearly legible and complete. Blurry, incomplete, or unreadable uploads may produce a weak or unusable record. We do not review document content for legal sufficiency.</span></li>
          ...
          <li className="flex gap-2"><span className="text-brand-500 font-bold shrink-0">·</span><span><strong>Record retention:</strong> We generate a certificate of completion containing the audit record for signed documents and strive to preserve it for retrieval by the sender, including after account cancellation. We do not warrant that records are complete, tamper-proof, or error-free. Maintain your own backups of important agreements when appropriate.</span></li>
        </ul>
    ...
    content: (
      <div className="space-y-3">
        ...
        <ul className="space-y-2 pl-4">
          ...
          <li className="flex gap-2"><span className="text-red-400 font-bold shrink-0">✗</span><span>Use Sign-by-Text or Doc Center for wills, codicils, testamentary trusts, certain family-law or court documents, powers of attorney, deeds, notarized instruments, or other instruments that typically need notarization, witnesses, or multiple signers.</span></li>
