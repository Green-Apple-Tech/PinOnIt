    ...
    content: (
      <div className="space-y-3">
        ...
        <ul className="space-y-2 pl-4">
          ...
          <li className="flex gap-2"><span className="text-brand-500 font-bold shrink-0">·</span><span><strong>Single-signature business use:</strong> Sign-by-Text and PDF upload flows are designed for <strong>single-signature business documents</strong> (for example, waivers, NDAs, addendums, estimates, and job sign-offs). They are <strong>not</strong> intended for wills, trusts, powers of attorney, deeds, court filings, notarized instruments, multi-signer closings, or other formal documents that typically require witnesses, notarization, or specialized formalities. You must not use the Service for illegal content or fraud.</span></li>
    ...
    content: (
      <div className="space-y-3">
        ...
        <ul className="space-y-2 pl-4">
          ...
          <li className="flex gap-2"><span className="text-red-400 font-bold shrink-0">✗</span><span>Use Sign-by-Text or Doc Center for wills, trusts, powers of attorney, deeds, court filings, or other instruments that typically need notarization, witnesses, or multiple signers.</span></li>
